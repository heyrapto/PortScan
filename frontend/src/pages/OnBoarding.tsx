...
const OnBoarding = () => {
    return (
      <section className="flex flex-col text-white items-center justify-center h-screen z-40">
        ...
        <span className="absolute bg-[#2FB6FF] md:blur-md md:w-[190px] rounded-[5px] md:h-[10px] md:bottom-[25px] right-0 z-0 w-[160px] h-[15px] bottom-[35px] blur-2xl"></span>
        </div>
