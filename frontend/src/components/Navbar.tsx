...
import { HomeIcon, Link, Menu, PhoneCallIcon, X } from "lucide-react";
    ...
    return (
        <nav className="flex justify-between px-12 py-6 items-center z-50 w-full">
            ...
            <div 
                ...
                <ul className="md:flex md:gap-10 flex-col bg-transparent">
                    <div className="flex gap-1">
                        <HomeIcon className="text-gray-400 w-[15px] md:flex hidden" />
                        <li><a href="#" className="text-gray-500 md:text-[0.7rem] text-[1rem]">Home</a></li>
                    </div>
                    <div className="flex gap-1">
                        <Link className="text-gray-400 w-[15px] md:flex hidden" />
                        <li><a href="#" className="text-gray-500 md:text-[0.7rem] text-[1rem]">Paste links</a></li>
                    </div>
                    <div className="flex gap-1">
                        <PhoneCallIcon className="text-gray-400 w-[15px] md:flex hidden" />
                        <li><a href="#" className="text-gray-500 md:text-[0.7rem] text-[1rem]">Contact us</a></li>
                    </div>
                </ul>
