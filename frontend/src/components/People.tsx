...
const People = () => {
  return (
    <div className="flex mt-[100px] py-[25px] relative w-full">
      ...
      <img src={person1} className="w-[70px] " />
      <img src={person2} className="w-[70px] " />
      <img src={person3} className="w-[70px] " />
      <img src={person4} className="w-[70px] " />
      <img src={person5} className="w-[70px] " />
      <img src={person6} className="w-[70px] " />
      <img src={person7} className="w-[70px] " />
      </div>
    </div>
  );
};
